...
namespace techville.services
{
    ...
    {
        //M-11 Service Queue Management (Array Queue)
        ArrayQueue arrayQueue = new ArrayQueue();
        //M-11 Service Queue Management (Priority Queue)
        PriorityQueue priorityQueue = new PriorityQueue();
        //M-11 Service Queue Management (Profile Stack)
        ProfileStack profileStack = new ProfileStack();
        //M-11 Service Queue Management (Circular Array Queue)
        ...
        public void RegisterCitizen()
        {
            ...
            try
            {
                ...
                //M-11 Service Queue Management (Circular Array Queue)
                circularArrayQueue.Enqueue(citizen);
        ...
        //M-11 Method to undo profile 
        public void UndoProfile()
        {
            Citizen previous = profileStack.Pop();
            if (previous != null)
            {
                Console.WriteLine("Undo Successful for: " + previous.Name);
            }

        }

        //M-11 Method to Add Emergency Request(priority queue)
        public void AddEmergencyRequest(Citizen citizen, int priority)
        {
            priorityQueue.Enqueue(citizen, priority);
        }

        //M-11 Method to Show Emergency Queue(priority queue)
        public void ShowEmergencyQueue()
        {
            priorityQueue.Display();
        }

        //M-11 Method to Show Array Queue(array queue)
        public void ShowArrayQueue()
        {
            arrayQueue.Display();
        }

        //M-11 Method to Show Circular Queue(circular queue)
        public void ShowCircularQueue()
        {
            circularArrayQueue.Display();
        }

        //M-11 Method to Find a citizen by name
